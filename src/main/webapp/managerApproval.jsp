...
<%
    // 1. Controller에서 전달받은 결재 대기 리스트를 가져옵니다.
        ...
        <tbody>
            ...
            %>
                <tr>
                    ...
                    <td>
                        <!-- 4. 1~5단계 서명 여부를 체크하여 O/X 및 색상을 표시합니다. -->
                    ...
                    <td>
                        <!-- 5. 승인/반려 버튼: 클릭 시 해당 액션과 대여번호를 컨트롤러로 전송합니다. -->
