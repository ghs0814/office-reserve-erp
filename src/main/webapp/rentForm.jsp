...
<body>
	...
	<div class="form-container">
		...
		<form action="rentProcess.do" method="post"
			onsubmit="return validateRentForm();">
			...
			<div class="form-group">
				<label>대여 시작일</label> <input type="date" id="rentalDate"
					name="rentalDate" required>
			</div>

			<div class="form-group">
				<label>반납 예정일</label> <input type="date" id="returnDate"
					name="returnDate" required>
			</div>
			<!-- 사용자 입력 신청 제목 -->
			<div>
				<label>기안 제목 : </label> <input type="text" name="title"
					placeholder="예: 5월 부서 워크샵용 노트북 대여 기안" required>
			</div>
			<div class="btn-group">
