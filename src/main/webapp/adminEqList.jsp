...
<%
    // Controller에서 보내준 전체 비품 목록 데이터를 request 영역에서 꺼냅니다.
...
<div class="container">
    ...
    <div class="insert-box">
        ...
        <form action="insertEq.do" method="post" style="display: flex; gap: 10px;">
            ...
            <input type="number" name="totalCount" placeholder="총 수량" required style="width: 100px;">
