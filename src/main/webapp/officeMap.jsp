...
<style>
	...
	.page-header { display: flex; justify-content: space-between; align-items: center; margin-bottom: 30px; border-bottom: 2px solid #343a40; padding-bottom: 15px; max-width: 1000px; margin-left: auto; margin-right: auto; }
	...
	.map-wrapper { background-color: #ffffff; padding: 30px; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.05); border: 1px solid #e9ecef; display: flex; flex-direction: column; align-items: center; max-width: 1000px; margin: 0 auto; }
	
	.reservation-header { width: 100%; text-align: left; margin-bottom: 25px; padding-bottom: 15px; border-bottom: 2px solid #212529; }
	.reservation-header h3 { margin: 0 0 5px 0; font-size: 20px; color: #212529; font-weight: 800; }
	.reservation-header p { margin: 0; font-size: 14px; color: #6c757d; }

	.floor-tabs { display: flex; gap: 10px; margin-bottom: 20px; width: 100%; }
